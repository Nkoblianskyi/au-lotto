          ...
          <Card className="bg-white shadow-2xl border-2 border-blue-200">
            ...
            <CardContent className="p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      className={`border-2 ${errors.email ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                    />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className={`border-2 ${errors.password ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                    />
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select value={formData.title} onValueChange={(value) => handleInputChange("title", value)}>
                      <SelectTrigger
                        className={`border-2 ${errors.title ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                      >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        className={`border-2 ${errors.firstName ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className={`border-2 ${errors.lastName ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                      />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="border-2 border-blue-200 focus:border-blue-600"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        className={`border-2 ${errors.zip ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className={`border-2 ${errors.location ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                      />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        className={`border-2 ${errors.street ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className={`border-2 ${errors.houseNumber ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                      />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        className={`border-2 ${errors.dateOfBirth ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className={`border-2 ${errors.placeOfBirth ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                      />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className={`border-2 ${errors.phone ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                    />
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className={`border-2 ${errors.iban ? "border-red-500" : "border-blue-200 focus:border-blue-600"}`}
                    />
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-900 to-blue-800 hover:from-blue-800 hover:to-blue-700 text-white font-bold py-3 text-lg"
                  disabled={isLoading}
                >
